...
describe('CorrelationComponent', () => {
  ...
  it('Should return r=0.9333 with the dataset Data_Test2', () => {
    spyOn(service, 'getData').withArgs(2).and.returnValue(of(testData2));
    component.getData(2);
    fixture.detectChanges();
  ...
  it('Should return r=0.9631 with the dataset Data_Test3', () => {
    spyOn(service, 'getData').withArgs(3).and.returnValue(of(testData3));
    component.getData(3);
    fixture.detectChanges();
  ...
  it('Should return r=0.9480 with the dataset Data_Test4', () => {
    spyOn(service, 'getData').withArgs(4).and.returnValue(of(testData4));
    component.getData(4);
    fixture.detectChanges();
